...
class UI:
	...
	def show_coins(self, amount):
		...
		coin_amt_surface = self.font.render(str(amount), False, WHITE)
		coin_amt_rect = coin_amt_surface.get_rect(midleft = (self.coin_rect.right + 6,self.coin_rect.centery))
		self.display_surface.blit(coin_amt_surface, coin_amt_rect)